    ...
    <div>
      ...
      <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
        ...
        <div className='flex gap-2 py-2'>
          <p>Address :</p>
          <p className='text-sm'>
            {isEdit ? <input type='text' value={profileData.address.line} onChange={(e) => setprofileData(prev => ({ ...prev, address: { ...prev.address, line: e.target.value } }))} /> : profileData.address.line}
            <br />
...

        {
          isEdit
            ...
            : <button onClick={() => SetEdit(true)} className='px-4 py-1 border border-[#5F6FFF] text-sm rounded-full mt-5 hover:bg-[#5F6FFF] hover:text-white transition-all'>Edit</button>
        }
